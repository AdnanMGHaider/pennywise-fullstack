...
export default function BudgetsPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setAllCategories(
          categoriesData.map((c) => c.name).filter((name) => name !== "Income")
        );
      } catch (error) {
  ...
  const handleEditBudget = async () => {
    ...
    try {
      ...
      setBudgets(
        budgets.map((b) => (b.id === editingBudget.id ? updatedBudgetDTO : b))
      );
          ...
          <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
            ...
            <DialogContent className="glass-morphism border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="budgetAmount" className="text-gray-300">
                    Budget Amount
                  </Label>
                  <Input
                    id="budgetAmount"
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`font-semibold ${getStatusColor(
                    getBudgetStatus(totalSpent, totalBudget)
                  )}`}
                >
                  ...
                  {status === "over" && (
                    <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-3">
                      ...
                      <p className="text-red-300 text-xs">
                        Consider adjusting your spending or budget amount
                      </p>
                    </div>
                  )}
        ...
        <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
          <DialogContent className="glass-morphism border-gray-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="edit-budgetAmount" className="text-gray-300">
                  Budget Amount
                </Label>
                <Input
              ...
              <div>
                <Label htmlFor="edit-month" className="text-gray-300">
                  Month
                </Label>
                <Input
                  id="edit-month"
