...
// import { mockTransactions, mockMonthlyData, aiAdviceTemplates } from '@/data/mockData'; // Removed
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {/* Percentage change can be added later if backend provides it or based on previous period data */}
                </div>
